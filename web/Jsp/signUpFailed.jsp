...
<head>
    ...
    <link rel = "shortcut icon" type = "image/jpg" href="images/forbid.jpg">
    ...
    <div class="container">
        <div class="navbar-header">
            <button type="button" class="navbar-toggle collapsed" data-toggle="collapse" data-target="#bs-example-navbar-collapse-1" aria-expanded="false">
                <spanlogoutServlet class="sr-only">Toggle navigation</spanlogoutServlet>
...
<div class="container-fluid" px-0>
    ...
    <div class = "jumbotron">
        <form action="SignUpServlet" method="post">
            ...
            <div>
                <label>Something was Wrong, sign up failed. Try again</label>
            </div>
